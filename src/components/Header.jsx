...
const Header = () => {
  ...
  return (
    <motion.div className='flex flex-col justify-center items-center text-center my-20'
      ...
      viewport = {{once:true}}>
      <motion.div className='text-stone-500 flex text-center gap-2 bg-white px-6 py-1  rounded-full border  border-neutral-500'
      ...
      initial={{opacity:0}}
      animate={{opacity:1,y:0}}
      transition={{delay:0.6,duration:2}}>Unleash your creativity with AI. Turn your imagination into visual art in seconds - just type, and watch the magic happen.</motion.p>
      ...
      className='flex flex-wrap justify-center mt-16 gap-3'>
        {Array(6).fill('').map((item,index)=>(
           <motion.img
           whilHover={{scale:1.05,duration:0.1}} 
