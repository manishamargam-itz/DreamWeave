...
import { motion } from "motion/react"
 // Replace with correct path or use a direct string for the image
...
const Description = () => {
  ...
  viewport={{once:true}}className="flex flex-col items-center justify-center my-24 p-6 md:px-28">
      ...
      <div className='flex gap-5 md:gap-14 md:flex-row items-center'>
        <img src={assets.sample_img_1} alt="Sample AI Image" className="w-80 xl:w-96 rounded-lg" />
        <div>
          <h2 className='text-3xl font-medium max-w-lg mb-4'>Introducing the AI-Powered Text to Image Generator</h2>
          <p className='text-gray-600 mb-4'>
            Easily bring your ideas to life with our free AI image generator. Whether you need stunning
            visuals or unique imaginary, our tool transforms your text into eye-catching images with just
